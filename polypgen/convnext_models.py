"""
ConvNeXt Model Factory adapted for PolypGen Colonoscopy Binary Classification.
"""
...
def create_convnext_model(
    ...
    try:
        import timm
        print(f"[ConvNeXt-Model] Loading '{model_name}' via timm for {num_classes}-class colonoscopy...")
