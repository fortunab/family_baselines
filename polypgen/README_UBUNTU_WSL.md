# Running PolypGen Baselines on Ubuntu / WSL (70/15/15 Split)

This guide walks you through setting up and running all 4 benchmark models on the **PolypGen dataset** inside **Ubuntu (WSL/WSL2)** using the **70% Train / 15% Val / 15% Test** evaluation protocol.

---

## 1. Access the PolypGen Project in WSL
...
nohup python3 main_convnext.py --model-name convnext_tiny > convnext_train.log 2>&1 &

# Monitor logs live
tail -f convnext_train.log
```
