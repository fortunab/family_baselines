# Herlev Baseline 4: Pathology & Vision Foundation Models (70/15/15 Split)

Foundation model feature extraction and linear probing for 7-class Pap smear single-cell dysplasia grading.
