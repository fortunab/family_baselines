"""
Main Execution Script for Vision Transformer / EVA-02 Baseline on Herlev Cervical Cytology.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Vision Transformer Fine-Tuning on Herlev Cytology")
...
def main():
    ...
    print("="*80)
    print(f"  HERLEV BASELINE 3: VISION TRANSFORMER ({args.model_name}) FINE-TUNING (70/15/15 SPLIT)")
    print("="*80)
