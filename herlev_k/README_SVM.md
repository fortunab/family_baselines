# Herlev Baseline 1: Handcrafted Texture & Color + RBF-SVM (70/15/15 Split)

Classical machine learning baseline for 7-class cervical cytology single-cell dysplasia grading.
