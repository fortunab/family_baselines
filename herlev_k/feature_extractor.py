"""
Handcrafted Cytological Feature Extractor for Pap Smear Cells (Herlev).
Extracts:
...
def extract_herlev_features_parallel(
    ...
    print(f"[FeatureExtractor] Extracting handcrafted features on {len(image_paths)} cervical cells...")
