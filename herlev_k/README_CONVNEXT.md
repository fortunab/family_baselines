# Herlev Baseline 2: Modern ConvNeXt CNN Fine-Tuning (70/15/15 Split)

Modern Convolutional Network baseline using **ConvNeXt-Tiny / Small** adapted for 7-class cervical cytology dysplasia grading.
