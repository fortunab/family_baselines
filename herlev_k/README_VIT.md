# Herlev Baseline 3: Vision Transformer Fine-Tuning (70/15/15 Split)

Vision Transformer fine-tuning pipeline (ViT-Base / EVA-02) adapted for 7-class Pap smear single-cell dysplasia grading.
