"""
Herlev Cervical Cytology 4-Tier Benchmark Comparison Script.
Compares:
...
def print_comparison_table(svm_m, cnx_m, vit_m, fnd_m):
    print("\n" + "="*125)
    print("           HERLEV CERVICAL CYTOLOGY BENCHMARK COMPARISON: 4-TIER LEADERBOARD")
    print("="*125)
...
def plot_side_by_side_bars(svm_m, cnx_m, vit_m, fnd_m, output_path: Path):
    ...
    plt.title('Herlev Cervical Cytology Benchmark Comparison (70/15/15 Split)', fontsize=13, weight='bold')
...
def main():
    ...
    plot_side_by_side_bars(svm_m, cnx_m, vit_m, fnd_m, results_dir / "herlev_benchmark_comparison.png")
