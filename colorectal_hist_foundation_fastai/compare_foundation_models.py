"""
Leaderboard Comparison & Visualization Script for fastai Pathology Foundation Models Suite.
Compares:
...
def print_comparison_table(models_data: List[Dict[str, Any]]):
    print("\n" + "=" * 145)
    print("    FASTAI PATHOLOGY FOUNDATION BENCHMARK LEADERBOARD: COLORECTAL HISTOLOGY")
    print("=" * 145)
...
def plot_side_by_side_bars(models_data: List[Dict[str, Any]], output_path: Path):
    ...
    plt.title(
        "Colorectal Histology 8-Class Benchmark Leaderboard (fastai Foundation Models)",
        fontsize=13,
        weight="bold",
    )
...
def main():
    ...
    plot_side_by_side_bars(
        models_data, results_dir / "pathology_foundation_benchmark_comparison.png"
    )
