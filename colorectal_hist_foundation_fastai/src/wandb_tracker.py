"""
Weights & Biases (W&B) Experiment Tracking Integration for fastai Pathology Foundation Models.
"""
...
class WandbExperimentTracker:
    def __init__(
        self,
        project_name: str = "colorectal-histology-pathology-foundation",
        experiment_name: str = "foundation_fastai_run",
        ...
        self.tags = tags or ["fastai", "foundation", "histology", "toml"]
