# Running Kvasir-VQA Foundation Benchmark on Windows (PowerShell & CMD)

This guide walks you through setting up and running all 4 Multimodal Foundation Models on the **Hugging Face `SimulaMet-HOST/Kvasir-VQA` dataset** on **Windows 10/11**.
