...
Salesforce's multimodal foundation model (`Salesforce/blip2-opt-2.7b`) adapted for visual question answering on **Hugging Face `SimulaMet-HOST/Kvasir-VQA`**.

---

## 🔬 Architecture Highlights
- Two-stage pre-trained Querying Transformer (Q-Former) bridging vision encoder with LLMs.
- Zero-shot and few-shot clinical question-answering capabilities on colonoscopy frames.
