# Running Kvasir-VQA Foundation Benchmark on Ubuntu / WSL (Linux)

This guide walks you through setting up and running all 4 Multimodal Foundation Models on the **Hugging Face `SimulaMet-HOST/Kvasir-VQA` dataset** inside **Ubuntu (WSL/WSL2)**.
