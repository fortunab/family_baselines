"""
Weights & Biases (W&B) Experiment Tracking & skorch Callback Integration.
"""
...
class WandbExperimentTracker:
    def __init__(
        self,
        project_name: str = "herlev-cytology-pathology-foundation",
        ...
        self.tags = tags or ["skorch", "foundation", "herlev", "cytology", "toml"]
...
class SkorchWandbCallback(Callback):
    ...
    def on_epoch_end(self, net, dataset_train=None, dataset_valid=None, **kwargs):
        ...
        epoch_metrics = {
            ...
            "valid_acc": float(last_epoch.get("val_acc", 0.0)),
            "duration": float(last_epoch.get("dur", 0.0)),
        }
        ...
        for k, v in last_epoch.items():
            if "lr" in k.lower():
                try:
                    epoch_metrics["learning_rate"] = float(v)
