"""
Herlev Pap Smear Cervical Cytology Dataset Loader & NumPy Tensor Extraction for skorch.
...
def extract_numpy_tensors(df: pd.DataFrame, img_size: int = 224) -> Tuple[np.ndarray, np.ndarray]:
    """
    Extracts image tensors as NumPy arrays for direct skorch / Scikit-Learn .fit() integration.
    """
