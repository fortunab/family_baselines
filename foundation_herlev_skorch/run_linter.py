"""
Automated Code Quality & Linter Runner for Herlev Foundation skorch Suite.
Runs:
...
def main():
    ...
    print("=" * 80)
    print("     HERLEV CYTOLOGY PATHOLOGY FOUNDATION SKORCH LINTER SUITE")
    print("=" * 80)
    ...
    # 2. Ruff Linter
    targets = ["src", "main_herlev_skorch.py", "compare_herlev_models.py", "run_linter.py"]
