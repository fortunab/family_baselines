# Ubuntu & Linux / WSL2 Setup Guide: Herlev Cytology skorch Foundation Suite

Step-by-step instructions for running the **Herlev Cervical Cytology Pathology Foundation skorch Suite** on Linux environments (Ubuntu 20.04/22.04 LTS, Debian, RedHat, or WSL2 on Windows 11).
...
## 4. Run Model Training with skorch
...
```bash
python main_herlev_skorch.py --config configs/phikon.toml --no_wandb
```
