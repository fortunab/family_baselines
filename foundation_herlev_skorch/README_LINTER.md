# Automated Code Quality & Linter Guide (skorch)
...
```powershell
black src main_herlev_skorch.py compare_herlev_models.py run_linter.py
ruff check --fix src main_herlev_skorch.py compare_herlev_models.py run_linter.py
```
