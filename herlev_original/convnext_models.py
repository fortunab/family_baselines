"""
ConvNeXt Model Factory adapted for Original MDE-Lab Herlev Cytology (7 Classes).
"""
...
def create_convnext_model(
    ...
    try:
        import timm
        print(f"[ConvNeXt-Model] Loading '{model_name}' via timm for {num_classes}-class MDE cytology...")
