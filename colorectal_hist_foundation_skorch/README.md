# Colorectal Histology Benchmark: Pathology Foundation Models in skorch + TOML + Weights & Biases (W&B) + Linter

A specialized benchmark suite engineered strictly around **State-of-the-Art Pathology Vision Foundation Models**, **[`skorch`](https://skorch.readthedocs.io/)** (`NeuralNetClassifier` with Scikit-Learn API), modular **TOML configurations**, **[Weights & Biases (W&B)](https://wandb.ai/) MLOps tracking**, and automated **code quality / linting tooling** (`ruff`, `flake8`, `black`, `isort`, `mypy`).
...
## 🏆 Pathology Foundation Model Families & skorch Pipelines

Each pathology foundation model has its own dedicated TOML configuration and skorch `NeuralNetClassifier` pipeline:

| Model # | Foundation Architecture | Backbone / Pre-training Source | Dedicated TOML Profile | Dedicated Guide |
| :---: | :--- | :--- | :--- | :--- |
| **1** | **Owkin Phikon** | `owkin/phikon` (iBOT ViT-Base on 40M+ TCGA tiles) | [`configs/phikon.toml`](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/configs/phikon.toml) | [README_PHIKON.md](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/README_PHIKON.md) |
| **2** | **Paige Virchow** | `paige-ai/Virchow` (ViT-Huge on 1.5M WSIs) | [`configs/virchow.toml`](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/configs/virchow.toml) | [README_VIRCHOW.md](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/README_VIRCHOW.md) |
| **3** | **Harvard UNI** | `MahmoodLab/UNI` (ViT-Large on 100M+ patches) | [`configs/uni.toml`](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/configs/uni.toml) | [README_UNI.md](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/README_UNI.md) |
| **4** | **Meta DINOv2** | `facebook/dinov2-base` (Self-supervised ViT) | [`configs/dinov2.toml`](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/configs/dinov2.toml) | [README_DINOV2.md](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/README_DINOV2.md) |
| **5** | **BiomedCLIP** | `microsoft/BiomedCLIP-PubMedBERT_256-vit_base_patch16_224` | [`configs/biomedclip.toml`](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/configs/biomedclip.toml) | [README_BIOMEDCLIP.md](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/README_BIOMEDCLIP.md) |

---

## 🛠️ Code Quality & Automated Linting

The repository includes a linter runner [`run_linter.py`](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/run_linter.py) and [`pyproject.toml`](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/pyproject.toml) supporting:
...
```
📖 **Guide**: [README_LINTER.md](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/README_LINTER.md)
...
- 📖 **Guide**: [README_TOML_WANDB.md](file:///C:/Users/Lenovo/.gemini/antigravity/scratch/colorectal_histology_pathology_foundation_skorch/README_TOML_WANDB.md)
...
# 8. Train Model 5 (BiomedCLIP)
python main_skorch_foundation.py --config configs/biomedclip.toml

# 9. Generate 5-Model Comparison Leaderboard & Chart
...
# 4. Run Training
python3 main_skorch_foundation.py --config configs/phikon.toml
python3 main_skorch_foundation.py --config configs/dinov2.toml
