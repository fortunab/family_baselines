"""
Pure TOML Configuration Engine & Schema Validator for Pathology Foundation Models in skorch.
...
def load_and_validate_config(
    ...
    # Flatten nested dictionary for quick access
    ...
    # Apply dynamic CLI overrides if supplied
    if cli_overrides:
...
def print_toml_summary(cfg: Dict[str, Any]):
    print("\n" + "=" * 85)
    print("         ACTIVE PATHOLOGY FOUNDATION SKORCH + TOML EXPERIMENT CONFIGURATION")
    print("=" * 85)
