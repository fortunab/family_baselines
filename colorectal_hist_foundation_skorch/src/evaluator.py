"""
Evaluation Metrics & Visualization Suite for skorch Pathology Foundation Models.
...
def print_evaluation_report(metrics: Dict[str, Any], model_name: str, seed: Optional[int] = None):
    print("\n" + "=" * 95)
    print(f"   COLORECTAL HISTOLOGY PATHOLOGY FOUNDATION REPORT: {model_name.upper()}")
    print("=" * 95)
    if seed is not None:
