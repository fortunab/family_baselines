"""
ConvNeXt Model Factory adapted for CVC-Colon Endoscopy (2 Classes).
"""
...
def create_convnext_model(
    ...
    try:
        import timm
        print(f"[ConvNeXt-Model] Loading '{model_name}' via timm for {num_classes}-class CVC endoscopy...")
