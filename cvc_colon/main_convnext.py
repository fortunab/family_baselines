"""
Main Execution Script for ConvNeXt Baseline on CVC-Colon Endoscopy.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="ConvNeXt Fine-Tuning on CVC-Colon Endoscopy")
...
def main():
    ...
    print("="*80)
    print(f"  CVC-COLON BASELINE 2: CONVNEXT ({args.model_name.upper()}) FINE-TUNING (70/15/15 SPLIT)")
    print("="*80)
    ...
    plot_roc_curves(y_true=res["y_true_test"], y_proba=res["y_proba_test"], output_path=results_dir / "roc_curves_convnext.png", title=f"ConvNeXt ({args.model_name}) - 15% Test ROC Curve")
