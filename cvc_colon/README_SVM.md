# CVC-Colon Baseline 1: Handcrafted Texture & Color + RBF-SVM (70/15/15 Split)

Classical machine learning baseline for binary colonoscopy polyp detection on the CVC-Colon databases (CVC-ClinicDB / CVC-ColonDB).
...
## 🔬 Feature Extraction (345 Dimensions)
1. **LBP (54 dims)**: Multiscale uniform LBP at $(P=8, R=1)$, $(P=16, R=2)$, $(P=24, R=3)$ capturing mucosa micro-vascular texture.
...
3. **Gabor Filter Bank (72 dims)**: 24 filters capturing polyp border and surface curvature.
4. **Color Descriptors (75 dims)**: Statistical moments across RGB, HSV, and CIE-Lab spaces for endoscopic tissue redness and illumination patterns.
