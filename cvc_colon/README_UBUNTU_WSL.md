# Running CVC-Colon Baselines on Ubuntu / WSL (70/15/15 Split)

This guide walks you through setting up and running all 4 benchmark models on the **CVC-Colon databases (CVC-ClinicDB / CVC-ColonDB)** inside **Ubuntu (WSL/WSL2)** using the **70% Train / 15% Val / 15% Test** evaluation protocol.
...
nohup python3 main_convnext.py --model-name convnext_tiny > convnext_cvc.log 2>&1 &

# Monitor logs live
tail -f convnext_cvc.log
```
