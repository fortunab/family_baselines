"""
Automated Code Quality & Linter Runner for Herlev Foundation FastAI Suite.
Runs:
1. Syntax Validation (ast.parse)
2. Ruff Style & Quality Checker
3. Flake8 Linter
...
def main():
    ...
    print("=" * 80)
    print("     HERLEV CYTOLOGY PATHOLOGY FOUNDATION FASTAI LINTER SUITE")
    print("=" * 80)
    ...
    # 2. Ruff Linter
    targets = ["src", "main_herlev_fastai.py", "compare_herlev_models.py", "run_linter.py"]
