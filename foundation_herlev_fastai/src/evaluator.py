"""
Evaluation Metrics & Visualization Suite for Herlev fastai Pathology Foundation Models.
...
def plot_confusion_matrix(
    ...
    y_pred: np.ndarray,
    output_path: Path,
    title: str = "fastai Foundation Confusion Matrix",
):
...
def plot_multiclass_roc(
    ...
    y_prob: np.ndarray,
    output_path: Path,
    title: str = "fastai Foundation Multi-Class ROC",
):
